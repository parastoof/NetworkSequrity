...
class DataIngestion:
    ...
    def export_data_into_featue_store(self, dataframe: pd.DataFrame):
        try:
            featue_store_file_path=self.data_ingestion_config.feature_store_file_path
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            ...
            logging.info("Performes train test split on the dataframe")
            logging.info("Existed split_data_as_train_test method of Data_Ingestion class")
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataframe=self.export_data_into_featue_store(dataframe)
